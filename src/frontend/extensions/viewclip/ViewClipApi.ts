...
*--------------------------------------------------------------------------------------------*/
import { AccuDrawHintBuilder, ContextRotationId, IModelApp, IModelConnection, ScreenViewport, StandardViewId, ViewClipClearTool, ViewClipDecorationProvider, ViewClipTool, Viewport } from "@itwin/core-frontend";
...
export default class ViewClipApi {
    ...
    public static setClipPlane(vp: ScreenViewport, clipPlane: string, imodel: IModelConnection) {
        ...
        const point: Point3d = imodel.projectExtents.center;
